...
/**
 * Created by jacinto on 4/24/14.
 */
public class Info   {

    private String Info18 = "Plaza: Plaza General Julio Argentino Roca\n\n"+"H. Nuevo: Hospital San Antonio de Padua, Guardias Nacionales 1000-1100";
    ...
    private String Info12=
            ...
            "\n\n"+
            "EPEC: Vélez Sarsfield 170\n\n"+"UNRC: Universidad Nacional, Ruta Nacional 36 KM 601\n\n"+"Plaza: Plaza General Julio Argentino Roca\n\n"+"H.Cent: Hospital Central,General Mosconi 201-299";
    private String Info11 = "Plaza: Plaza General Julio Argentino Roca\n\n"+"Comun: Comunicaciones, Ex cancha Correo, Gerónimo del Barco esquina Ordoñez\n\n"+"IPVFen: IPV Fenix";
    private String Info10= "Plaza: Plaza General Julio Argentino Roca\n\n"+"Comun: Comunicaciones, Ex cancha Correo, Gerónimo del Barco esquina Ordoñez\n\n"+"IPVF: IPV Fenix";
    private String Info9R= "EPEC: Vélez Sarsfield 170\n\n"+"IPV.BN: IPV Banda Norte\n\n"+"UNRC: Universidad Nacional, Ruta Nacional 36 KM 601\n\n"+"M.ABA: Mercado de Abasto\n\n"+"IPV.ALB: IPV Alberdi";
    private String Info9V="EPEC: Vélez Sarsfield 170\n\n"+"IPV.BN: IPV Banda Norte\n\n"+"UNRC: Universidad Nacional, Ruta Nacional 36 KM 601\n\n"+"M.ABA: Mercado de Abasto\n\n"+"IPV.ALB: IPV Alberdi";
    private String Info8R="Referencias: P. Palestro\n\n"+"Plaza: Plaza General Julio Argentino Roca\n\n"+"UNRC: Universidad Nacional, Ruta Nacional 36 KM 601\n\n"+"Va. Dalcar: Barrio Villa Dalcar\n\n"+"ANTENA: Country San Esteban, Ruta Provincial 30 Km 4\n\n"+"Golf: Villa Golf Club";
    private String Info8v="Referencias: P. Palestro - S.E. Barrio San Esteban\n\n"+"Plaza: Plaza General Julio Argentino Roca\n\n"+"UNRC: Universidad Nacional, Ruta Nacional 36 KM 601\n\n"+"Va. Dalcar: Barrio Villa Dalcar\n\n"+"ANTENA: Country San Esteban, Ruta Provincial 30 Km 4\n\n"+"Golf: Villa Golf Club";
    ...
    public String getInfo18() { return Info18; }
    ...
    public String getInfo9R() {
        return Info9R;
    }

    public String getInfo9V() {
        return Info9V;
    }
    ...
    public String getInfo2R() {
        return Info2R;
    }

    public String getInfo2V() {
        return Info2V;
    }

    public String getInfo1R() {
        return Info1R;
    }

    public String getInfo1V() {
        return Info1V;
    }
}
